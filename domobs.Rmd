...
```{r, Code to randomize the interaction matrices and determine if slopes are "significant, include=F}
...
```{r, Visualization of density plots}
...
slopes2$actual<-slopes$Slopes
slopes2$sig<-if_else(slopes2$actual>slopes2$lCI & slopes2$actual<slopes2$uCI, 
                     "p>0.05", "p<0.05")
